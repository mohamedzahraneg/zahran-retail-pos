...
/**
 * PR-FIN-PAYACCT-4D-UX-FIX-6 — Defensive sanitizer for optional UUID
 * inputs (DTO fields + actor IDs). Returns null when the value is
 * missing OR the literal sentinel strings `"undefined"` / `"null"`,
 * which used to slip past the FE's empty-string-only normalization
 ...
 */
function sanitizeUuidInput(v: unknown): string | null {
