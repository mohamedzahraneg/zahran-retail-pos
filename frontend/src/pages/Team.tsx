...
// PR-T6 cleanup — legacy Payroll / Attendance / AdminAttendancePanel
// imports removed. The standalone routes /payroll and /attendance are
// permanent redirects to the unified workspace (see App.tsx).
